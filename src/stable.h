...
static double stable_pdf_g(double theta, void *dist);
static double stable_pdf_g_aux1(double theta, void *args);
static double stable_pdf_g_aux2(double theta, void *args);
...
static void stable_cdf(StableDist *dist, const double* x, const unsigned int Nx,
...
static double stable_cdf_g(double theta, void *dist);

/******************************************************************************/
/*   CDF^{-1} (quantiles)                                                     */
/******************************************************************************/

static double stable_q_point(StableDist * dist, const double q, double * err);
static void   stable_q(StableDist *dist, const double* q, const unsigned int Nq,
