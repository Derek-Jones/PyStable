...
static double stable_pdf_g1(double theta, void *args)
{
...
static double stable_pdf_g2(double theta, void *args)
{
  StableDist *dist = (StableDist *)args;
...
static double stable_pdf_g(double theta, void *args)
{
  StableDist * dist = (StableDist *)args;
...
static double stable_g_aux1(double theta, void *args)
{
  StableDist *dist = (StableDist *)args;
  double g, V,aux;
...
static double stable_g_aux2(double theta, void *args)
{
  StableDist *dist = (StableDist *)args;
  double g, cos_theta,aux,V;
...
static double stable_g_aux(double theta, void *args)
{
  StableDist *dist = (StableDist *)args;
...
static void * thread_init_pdf(void *ptr_args)
{
...
// printf("GAUSS: x %f, sigma %f, mu %f\n", x, dist->sigma, dist->mu_0);
